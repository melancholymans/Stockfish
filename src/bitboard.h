...
/*
îÚÇ—ãÓópÇÃóòÇ´bitboard
<ó·>
	sÇ…rookÇ™Ç¢ÇÈéûÇÃRAttacksÇ™ï‘Ç∑bitboardÇÃ
	RAttacksÇÕbitboardîzóÒ,èâä˙âªÇÕinit_magicsä÷êîÇ≈
	çsÇ§
+---+---+---+---+---+---+---+---+
|   |   |   |   | X |   |   |   |
+---+---+---+---+---+---+---+---+
...
+---+---+---+---+---+---+---+---+
ÅÉó·ÅÑ
	sÇ…bishopÇ™Ç¢ÇÈÇ∆Ç´ÇÃBAttacksÇ™ï‘Ç∑bitboard
